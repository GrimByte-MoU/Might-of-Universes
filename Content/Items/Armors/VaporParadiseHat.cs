...
namespace MightofUniverses.Content.Items.Armors
{
    ...
    public class VaporParadiseHat : ModItem
    {
        ...
        public override void UpdateArmorSet(Player player)
        {
            ...
            player.setBonus = $"+60% pacifist damage, -30% damage to all classes\nFour Vaporwave Suns orbit you dealing 45 damage\nPress '{key}' to summon 4 more suns that orbit you twice as fast, orbit further and deal double damage for 5 seconds\nThis ability has a 20 second cooldown";
