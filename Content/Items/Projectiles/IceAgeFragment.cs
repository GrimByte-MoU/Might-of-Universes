...
{
    public class IceAgeFragment : MoUProjectile
    {
        ...
        public override bool SafePreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < Projectile.oldPos.Length; i++)
            {
                ...
                Main.EntitySpriteDraw(texture, trailPos, null, trailColor, Projectile.oldRot[i], drawOrigin, Projectile.scale * 0.8f, SpriteEffects.None, 0);
            }
