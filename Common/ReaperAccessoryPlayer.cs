...
using MightofUniverses.Content.Items.Buffs;              // Spineless, EnemyBleeding, ProtectionCantrip, SpiritsTag
using MightofUniverses.Content.Items.Projectiles;       // VisceraBoltProj, SoulWispProj (spawned elsewhere)
...
namespace MightofUniverses.Common.Players
{
    ...
    public class ReaperAccessoryPlayer : ModPlayer
    {
        ...
        // =========================
        // NEW: Accessory flags (soul utility line)
        // =========================
        ...
        private float reportedPassiveSoulGenPS;   // external systems report here per tick
        ...
        // Cached soul state (if your system feeds it)
        ...
        {
            // Existing: Ferryman cooldown, largest spend window
            ...
            if (accThreadsOfSoul)
            {
                ...
                if (threadsPanicTimer > 0)
                {
                    ...
                    // TODO: If you want this to actually add souls, add into your ReaperPlayer here.
                }
            ...
            if (accSkeletonKnickknack && IsBelowSoulPercent(0.30f))
            {
                ...
                // TODO: Also add to soul resource if desired.
            }
            ...
            if (totalPS > 0f && passiveSoulToHpScalar > 0f)
            {
                ...
                Player.lifeRegen += (int)Math.Round(hpPerSecond * 2f); // lifeRegen: half-HP/sec units
            }
        }
        ...
        // External systems (armors/auras) should report positive passive souls/sec here.
        ...
        // Compute extra max souls to add onto your base when you finalize max
        ...
        {
            passiveSoulToHpScalar = Math.Max(passiveSoulToHpScalar, scalar); // non-stacking: take best
        }
