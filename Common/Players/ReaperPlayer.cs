...
namespace MightofUniverses.Common.Players
{
    public class ReaperPlayer : ModPlayer
    {
        ...
        public bool ConsumeSoulEnergy(float amount)
        {
            ...
            int adjustedCost = SoulCostHelper.ComputeEffectiveSoulCostInt(Player, amount);

            if (soulEnergy >= adjustedCost)
            {
                soulEnergy -= adjustedCost;
                lastSoulsConsumed = adjustedCost;
