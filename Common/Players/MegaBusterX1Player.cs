...
{
    public class MegaBusterX1Player : ModPlayer
    {
        public bool isChargeMode = false;
        
        private int chargeTime = 0;
        private const int ChargeLevel1Time = 60;
        private const int ChargeLevel2Time = 120;
        ...
        {
            bool holdingMegaBusterX1 = Player.HeldItem.type == ModContent.ItemType<Content.Items.Weapons.MegaBusterX1>();
            
            if (!holdingMegaBusterX1 || !isChargeMode)
            {
                ResetCharge();
                return;
            }
        ...
        public void ReleaseCharge(Player player, Vector2 position, Vector2 velocity)
        {
            ...
            else if (chargeLevel == 1)
            {
                ...
                damage = (int)(player.HeldItem.damage * 10f);
                scale = 1.5f;
            ...
            else
            {
                ...
                damage = (int)(player.HeldItem.damage * 20f);
                scale = 2.5f;
